...
from app.domain.models.repositories.booking import BookingRepository
from app.domain.services.base import ModelService
...
class BookingService(
    ...
    async def has_user_booked_studio(
        self, user_id: int, studio_id: int, room_id: int | None = None
    ) -> bool:
        where = [
