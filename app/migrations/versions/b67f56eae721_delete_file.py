...
def downgrade() -> None:
    ...
    op.add_column(
        'rooms',
        sa.Column('banner_id', sa.UUID(), autoincrement=False, nullable=True),
    )
    op.create_table(
        'files',
        ...
        sa.Column(
            'extension',
            postgresql.ENUM(
                'JPEG', 'PNG', 'WEBP', name='supportedfileextensions'
            ),
            autoincrement=False,
            nullable=False,
        ),
    ...
    op.create_foreign_key(
        'rooms_banner_id_fkey', 'rooms', 'files', ['banner_id'], ['name']
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['image_id'], ['files.name'], name='room_images_image_id_fkey'
        ),
        sa.ForeignKeyConstraint(
            ['room_id'], ['rooms.id'], name='room_images_room_id_fkey'
        ),
